...
- Selected: `assigned` — Inbetriebnahme-Pass
...
- Campaign model: do not send Template 1 alone or split leads by template. The initial SHK showroom launches for outreach only after three distinct production-ready templates are live; every qualified SHK lead receives that shared showroom.
